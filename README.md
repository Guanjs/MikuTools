...
<p align="center">
    <a href="https://github.com/Ice-Hazymoon/MiqiTools/blob/master/LICENSE">
        <img src="https://img.shields.io/github/license/Ice-Hazymoon/MiqiTools.svg" alt="MIT License" />
    </a>
...
本项目是 [https://miqitools](https://miqitools) 的开源版本，保留了部分无需后端的功能。

> [https://miqitools](https://miqitools)
...
Q: 我可以参与开发 MiqiTools 吗？  
A: 当然可以，随时欢迎提交 PR，会视情况添加到 [MiqiTools](https://miqitools) 主站

Q: 我能给 MiqiTools 提新功能吗？  
A: issues 区随时欢迎你。

Q: MiqiTools 的主要技术栈是什么？  
A: Vue 全家桶 + [Nuxt.js](https://zh.nuxtjs.org/)

## 更新

本仓库仅供一个开源版本的备份，并不用于纪录提交纪录等，当[主站](https://miqitools)更新到一定程度上的稳定版本时，才会重新更新该仓库

## License

[MIT](https://github.com/Ice-Hazymoon/MiqiTools/blob/master/LICENSE)
